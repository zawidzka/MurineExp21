...
colnames(sample_md)
fwrite(sample_md, "sample_metadata2.csv")

# prep sample_md_PBvsBM for analysis of BM vs Tumor
# sample_md_PBvsBM <- sample_md
# sample_md_PBvsBM[, condition := fifelse(grepl("PB", condition), "PB", "BM")]
...
saveRDS(sce, file = "SCE_BMvsTUM2.rds")
